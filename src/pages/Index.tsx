...
const IMG_PORTFOLIO_1 = "https://cdn.poehali.dev/projects/6c469352-41c5-4b96-8df3-570bbd28f50e/files/a41182e1-4a2f-4cf4-b2b4-78e4b0705c16.jpg";
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-24">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-8 mt-12">
              {[["500+", "объектов сдано"], ["10 лет", "на рынке"], ["3 часа", "выезд на объект"]].map(([num, label]) => (
                <div key={num}>
              ...
              <div className="space-y-8">
                ...
                <div className="rounded-lg p-6 flex flex-col md:flex-row md:items-center justify-between gap-4" style={{ background: "rgba(249,115,22,0.1)", border: "1px solid rgba(249,115,22,0.3)" }}>
                  <div>
                    ...
                    <div className="text-4xl font-bold" style={{ fontFamily: "Oswald, sans-serif", color: "#F97316" }}>
